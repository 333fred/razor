...
internal abstract class Tokenizer : ITokenizer
{
    ...
    private struct LookaheadToken(SeekableTextReader buffer) : IDisposable
    {
        private readonly SeekableTextReader _buffer = buffer;
        private readonly int _position = buffer.Position;
